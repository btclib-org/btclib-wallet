...
"""Tests for the `btclib_wallet.slip132` module."""
...
def test_an_already_built_key_is_validated_too() -> None:
    """`address_from_xpub` and `_helper_checks` (rule of btclib-org/btclib#684).
...
def test_slip132_test_vectors() -> None:
    ...
    for version, der_path, prv, pub, addr in test_vectors:
        ...
        # answers one address (issue btclib-org/btclib#1188)
