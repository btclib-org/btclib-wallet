...
"""What the btclib_wallet.fetch tests share: a transport that opens no socket.
...
# the first eighty bytes of tests/block/_data/block_481824_complete.bin,
# i.e. the header of that same block -- its hash, recomputed by
# BlockHeader.parse, is TIP_ID above, which is what makes this vector checkable
# without a node
TIP_HEADER_RAW = (
