...
from btclib_wallet.mnemonic.electrum import ELECTRUM_WORDLISTS
from btclib_wallet.mnemonic.mnemonic import BIP39_LANGUAGE_FILES, WORDLISTS
...
def test_word_order() -> None:
    ...
    # entirely, which is the whole of issue btclib-org/btclib#196. The public
    # function cannot be asked: the reversed sentence hashes to no version
    # prefix, so it is not an electrum mnemonic at all and is refused before it
    # is ever decoded
