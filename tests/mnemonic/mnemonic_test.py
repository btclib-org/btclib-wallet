...
"""Tests for the `btclib_wallet.mnemonic` module."""
...
def test_mnemonic_lang_names_the_shipped_word_lists() -> None:
    ...
    reason no lang parameter is typed with the alias (issue
    btclib-org/btclib#216), and the reason the alias needs a check of its own
