...
"""Tests for the `btclib_wallet.mnemonic.dispatch` module.
...
from btclib_wallet.mnemonic import bip39, dispatch, electrum, slip39
...
def test_no_normalization_of_its_own() -> None:
    ...
    for all of them, is issue btclib-org/btclib#201, and this pins the position
    the dispatcher takes until that is settled: none.
    """
    shouted = (
        "OSTRICH SECURITY DEER AUNT CLIMB INNER ALPHA ARM MUTUAL MARBLE SOLID TASK"
    )
