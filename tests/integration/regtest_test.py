...
Every part of issue btclib-org/btclib#381's pure half meets its counterparty
here, and the counterparty is the one that decides:
...
from btclib_wallet.core_import import (
    DEFAULT_RANGE,
...
def test_core_imports_what_btclib_exports_and_relays_what_it_signs(
    ...
    """The pure half, end to end, with a node as the judge.

    The half is issue btclib-org/btclib#381's.
    """
