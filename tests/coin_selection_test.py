...
"""Tests for the `btclib_wallet.coin_selection` module.
...
import btclib_wallet.coin_selection as coin_selection_module
from btclib_wallet.coin_selection import (
    CHANGE_LOWER,
    Candidate,
    SelectionResult,
    _branch_and_bound,
...
from btclib_wallet.tx_builder import _target_overhead_vsize, build_psbt
