...
- `script_wallet` is `ScriptWallet`, a script template with `KeyGroup`
  ...
  descriptors. What it does reach for is `btclib_wallet.descriptors`, one layer
...
`btclib_wallet.wallet`, the four modules being where they are written rather
than how they are reached.
"""

from btclib_wallet.wallet.descriptor_wallet import DescriptorWallet
from btclib_wallet.wallet.key_wallet import BIP32KeyWallet, KeyWallet
from btclib_wallet.wallet.script_wallet import KeyGroup, ScriptWallet
