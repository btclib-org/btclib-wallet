...
class Bip21:
    ...
    def network_type(self) -> NetworkType:
        ...
        the whole of what an address carries -- issue btclib-org/btclib#207 --
        and it is the question a payment URI actually raises, a payer needing to
    ...
    def parse(cls, uri: str, *, check_validity: bool = True) -> Bip21:
        ...
        CONTRIBUTING.md's "The public surface" states, this parameter
        declaring one type.
        """
