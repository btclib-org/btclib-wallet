...
`btclib_wallet.psbt.psbt_in` and `psbt_out` carry the four MuSig2 fields; what
...
the shape an interactive threshold scheme needs (issue btclib-org/btclib#257).
...
get it -- is the quadratic shape issue btclib-org/btclib#1046 fixed.
"""
...
def nonce_gen(
    ...
    *,
    ...
    # to decode -- an explicit call where a union guessed (issue
