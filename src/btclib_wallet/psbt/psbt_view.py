...
memory available to hold it (issue btclib-org/btclib#647).
...
transaction once instead of N times (issue btclib-org/btclib#164 for the
whole-object half of the same arithmetic).
